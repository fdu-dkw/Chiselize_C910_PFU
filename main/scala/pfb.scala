...
class pfbIO extends Bundle {
  ...
  val ld_da_ppn_ff = Input(UInt(28.W))val ld_da_ppn_ff =输入(UInt(28 w))
  val lsu_pfu_l1_dist_sel = Input(UInt(4.W))val lsu_pfu_l1_dist_sel =输入(UInt(4.W))
  val lsu_pfu_l2_dist_sel = Input(UInt(4.W))val lsu_pfu_l2_dist_sel =输入(UInt(4.W))
  ...
  val pfu_get_ppn = Input(UInt(28.W))val pfu_get_ppn =输入(UInt(28 w))
