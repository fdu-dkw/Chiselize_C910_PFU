...
class ct_lsu_pfu() extends Module {
  ...
  val pfu_pfb_entry_biu_pe_req_src = Vec(Seq.fill(8)(Wire(UInt(2.W))));
  ...
  val pfu_pfb_entry_l1_pf_addr = Vec(Seq.fill(8)(Wire(Vec(40,UInt(1.W)))));
  val pfu_pfb_entry_l1_vpn = Vec(Seq.fill(8)(Wire(UInt(28.W))));
  val pfu_pfb_entry_l2_page_sec = Wire(UInt(8.W));
  val pfu_pfb_entry_l2_page_share = Wire(UInt(8.W));
  val pfu_pfb_entry_l2_pf_addr = Vec(Seq.fill(8)(Wire(Vec(40,UInt(1.W)))));
  val pfu_pfb_entry_l2_vpn = Vec(Seq.fill(8)(Wire(UInt(28.W))));
  val pfu_pfb_entry_mmu_pe_req = Wire(UInt(8.W));
  val pfu_pfb_entry_mmu_pe_req_grnt = Wire(UInt(8.W));
  val pfu_pfb_entry_mmu_pe_req_src = Vec(Seq.fill(8)(Wire(UInt(2.W))));
  val pfu_pfb_entry_priv_mode = Vec(Seq.fill(8)(Wire(UInt(2.W))));
  ...
  val pfu_pmb_entry_pc = Vec(Seq.fill(8)(Wire(UInt(15.W))));
  ...
  x_ct_lsu_pfu_sdb_entry(0).pfu_pop_all_part_vld:= pfu_pop_all_part_vld
  x_ct_lsu_pfu_sdb_entry(0).pfu_sdb_create_pc:= pfu_sdb_create_pc
  x_ct_lsu_pfu_sdb_entry(0).pfu_sdb_create_type_ld:= pfu_sdb_create_type_ld 
  x_ct_lsu_pfu_sdb_entry(0).pfu_sdb_entry_create_dp_vld_x:= pfu_sdb_entry_create_dp_vld(0)
  x_ct_lsu_pfu_sdb_entry(0).pfu_sdb_entry_create_gateclk_en_x:=pfu_sdb_entry_create_gateclk_en(0) 
  x_ct_lsu_pfu_sdb_entry(0).pfu_sdb_entry_create_vld_x :=pfu_sdb_entry_create_vld(0) 
  ...
  x_ct_lsu_pfu_sdb_entry(0).pfu_sdb_entry_ready_grnt_x :=pfu_sdb_entry_ready_grnt(0) 
  ...
  x_ct_lsu_pfu_sdb_entry(1).pfu_pop_all_part_vld:=pfu_pop_all_part_vld 
  x_ct_lsu_pfu_sdb_entry(1).pfu_sdb_create_pc :=pfu_sdb_create_pc 
  x_ct_lsu_pfu_sdb_entry(1).pfu_sdb_create_type_ld :=pfu_sdb_create_type_ld 
  x_ct_lsu_pfu_sdb_entry(1).pfu_sdb_entry_create_dp_vld_x :=pfu_sdb_entry_create_dp_vld(1) 
  x_ct_lsu_pfu_sdb_entry(1).pfu_sdb_entry_create_gateclk_en_x :=pfu_sdb_entry_create_gateclk_en(1) 
  x_ct_lsu_pfu_sdb_entry(1).pfu_sdb_entry_create_vld_x:=pfu_sdb_entry_create_vld(1)  
  ...
  x_ct_lsu_pfu_sdb_entry(1).pfu_sdb_entry_ready_grnt_x :=pfu_sdb_entry_ready_grnt(1) 
  ...
  for (i <- 0 to 7) {
    ...
    ct_lsu_pfu_pfb_entry(i).pfu_pfb_entry_biu_pe_req_grnt_x:= io.pfu_pfb_entry_biu_pe_req_grnt(i) 
    ...
    ct_lsu_pfu_pfb_entry(i).pfu_pfb_entry_create_dp_vld_x :=io.pfu_pfb_entry_create_dp_vld(i) 
    ct_lsu_pfu_pfb_entry(i).pfu_pfb_entry_create_gateclk_en_x :=io.pfu_pfb_entry_create_gateclk_en(i) 
    ct_lsu_pfu_pfb_entry(i).pfu_pfb_entry_create_vld_x :=io.pfu_pfb_entry_create_vld(i) 
    io.pfu_pfb_entry_evict(i) := ct_lsu_pfu_pfb_entry(i).pfu_pfb_entry_evict_x
    ct_lsu_pfu_pfb_entry(i).pfu_pfb_entry_from_lfb_dcache_hit_x :=io.pfu_pfb_entry_from_lfb_dcache_hit(i) 
    ct_lsu_pfu_pfb_entry(i).pfu_pfb_entry_from_lfb_dcache_miss_x :=io.pfu_pfb_entry_from_lfb_dcache_miss(i) 
    ...
    ct_lsu_pfu_pfb_entry(i).pfu_pfb_entry_mmu_pe_req_grnt_x :=io.pfu_pfb_entry_mmu_pe_req_grnt(i) 
...
val x_ct_lsu_pfu_gsdb = Module(new ct_lsu_pfu_gsdb)
  ...
  io.pfu_gsdb_gpfb_create_vld:=ct_lsu_pfu_gsdb.io.pfu_gsdb_gpfb_create_vld
  io.pfu_gsdb_gpfb_pop_req      :=ct_lsu_pfu_gsdb.io.pfu_gsdb_gpfb_pop_req  
  io.pfu_gsdb_stride           := ct_lsu_pfu_gsdb.io.pfu_gsdb_stride        
  io.pfu_gsdb_stride_neg       := ct_lsu_pfu_gsdb.io.pfu_gsdb_stride_neg    
  io.pfu_gsdb_strideh_6to0 := ct_lsu_pfu_gsdb.io.pfu_gsdb_strideh_6to0 
...
// &Instance("ct_lsu_pfu_gpfb","x_ct_lsu_pfu_gpfb"); @391
  ...
  io.pfu_gpfb_biu_pe_req            :=  ct_lsu_pfu_gpfb.io.pfu_gpfb_biu_pe_req         
  ct_lsu_pfu_gpfb.io.pfu_gpfb_biu_pe_req_grnt       := io.pfu_gpfb_biu_pe_req_grnt     
  io.pfu_gpfb_biu_pe_req_src        :=  ct_lsu_pfu_gpfb.io.pfu_gpfb_biu_pe_req_src     
  ...
  io.pfu_gpfb_l1_page_sec           :=ct_lsu_pfu_gpfb.io.pfu_gpfb_l1_page_sec          
  io.pfu_gpfb_l1_page_share := ct_lsu_pfu_gpfb.io.pfu_gpfb_l1_page_share       
  io.pfu_gpfb_l1_pf_addr            :=ct_lsu_pfu_gpfb.io.pfu_gpfb_l1_pf_addr           
  io.pfu_gpfb_l1_vpn                :=ct_lsu_pfu_gpfb.io.pfu_gpfb_l1_vpn               
  io.pfu_gpfb_l2_page_sec           :=ct_lsu_pfu_gpfb.io.pfu_gpfb_l2_page_sec          
  io.pfu_gpfb_l2_page_share         :=ct_lsu_pfu_gpfb.io.pfu_gpfb_l2_page_share        
  io.pfu_gpfb_l2_pf_addr            :=ct_lsu_pfu_gpfb.io.pfu_gpfb_l2_pf_addr           
  io.pfu_gpfb_l2_vpn                :=ct_lsu_pfu_gpfb.io.pfu_gpfb_l2_vpn               
  io.pfu_gpfb_mmu_pe_req            :=ct_lsu_pfu_gpfb.io.pfu_gpfb_mmu_pe_req           
  ct_lsu_pfu_gpfb.io.pfu_gpfb_mmu_pe_req_grnt       := io.pfu_gpfb_mmu_pe_req_grnt     
  io.pfu_gpfb_mmu_pe_req_src        :=ct_lsu_pfu_gpfb.io.pfu_gpfb_mmu_pe_req_src       
  io.pfu_gpfb_priv_mode              :=ct_lsu_pfu_gpfb.io.pfu_gpfb_priv_mode           
  io.pfu_gpfb_vld                   :=ct_lsu_pfu_gpfb.io.pfu_gpfb_vld                  
...
pfu_biu_l1_pe_req_addr_tto6 := ((0 to 7).map { i =>
    Seq.fill(34)(pfu_biu_pe_req_ptr(i)).reduce(_ ## _) & pfu_pfb_entry_l1_pf_addr(i)(39,6)
  }.reduce(_ | _)) | Seq.fill(28)(pfu_mmu_pe_req_ptr(8)).reduce(_ ## _) & pfu_gpfb_l1_pf_addr(39,6)

pfu_biu_l2_pe_req_addr_tto6 := ((0 to 7).map { i =>
    Seq.fill(34)(pfu_biu_pe_req_ptr(i)).reduce(_ ## _) & pfu_pfb_entry_l2_pf_addr(i)(39,6)
  }.reduce(_ | _)) | Seq.fill(28)(pfu_mmu_pe_req_ptr(8)).reduce(_ ## _) & pfu_gpfb_l2_pf_addr(39,6)
...
pfu_biu_pe_req_src := ((0 to 7).map { i =>
    Seq.fill(2)(pfu_biu_pe_req_ptr(i)).reduce(_ ## _) & pfu_pfb_entry_biu_pe_req_src(i)
...
pfu_biu_pe_req_addr_tto  := Mux(pfu_biu_pe_req_sel_l1, pfu_biu_l1_pe_req_addr_tto6, pfu_biu_l2_pe_req_addr_tto6)
...
pfu_biu_pe_req_priv_mode := ((0 to 7).map { i =>
    Seq.fill(2)(pfu_biu_pe_req_ptr(i)).reduce(_ ## _) & pfu_pfb_entry_priv_mode(i)
  }.reduce(_ | _)) | Seq.fill(2)(pfu_mmu_pe_req_ptr(8)).reduce(_ ## _) & pfu_gpfb_priv_mode

pfu_biu_pe_req_priv_mode := ((8 to 0).map { i =>
    Seq.fill(9)(pfu_biu_pe_req_ptr(i)).reduce(_ ## _) & (1023.U(9.W) >> i)
  }.reduce(_ | _)) 

//--------------------page_sel------------------------------
//--------------------hit index signal----------------------
pfu_biu_req_addr := pfu_biu_req_addr_tto6 ## 0.U(6.W)
pfu_biu_req_hit_idx    := ld_da_pfu_biu_req_hit_idx
...
pfu_biu_ar_req   := pfu_biu_req_unmask
                          &&  !cp0_lsu_no_op_req
                          &&  (!pfu_biu_req_hit_idx
                          &&  !lfb_addr_full
                          &&  (lfb_pfu_rready_grnt
...
pfu_biu_ar_dp_req := pfu_biu_req_unmask
                          &&  !cp0_lsu_no_op_req
                          &&  (!lfb_addr_full
                          &&  (lfb_pfu_rready_grnt
                          || rb_pfu_nc_no_pending)
...
fu_biu_ar_snoop   := Mux(pfu_biu_req_page_share, 1.U(4.W), 0.U(4.W))
pfu_biu_ar_domain := 0.U ## pfu_biu_req_page_share
pfu_biu_ar_bar    := 2.U
//------------------------req lfb---------------------------
pfu_lfb_id := ((0 to 8).map { i =>
    Seq.fill(4)(pfu_biu_req_ptr(i)).reduce(_ ## _) & i.U(4.W)
  }.reduce(_ | _)) 
